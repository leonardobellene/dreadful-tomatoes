...
describe("SearchBar component", () => {
    ...
    it("renders the search bar input and year picker button", () => {
        render(
            <Provider store={store}>
                <SearchBar programType="movies" />
            </Provider>
        );
    ...
    it("renders the search bar input and year picker button", () => {
        render(
            <Provider store={store}>
                <SearchBar programType="series" />
            </Provider>
        );

        const searchBarDiv = screen.getByTestId("search-bar-div");
